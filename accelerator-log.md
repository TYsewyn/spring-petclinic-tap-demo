...
```json
{
  ...
  "projectName" : "spring-petclinic-tap-demo"
}
```
## Log
```
...
┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [spring-petclinic->spring-petclinic-tap...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [: spring-petclinic->: spring-petclinic-t...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [spring-petclinic template repo->spring-petclinic-tap...(truncated)]
