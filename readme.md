...
```
tanzu apps workload create spring-petclinic-tap-demo -f config/workload.yaml \
  --local-path . \
  --source-image <REPOSITORY-PREFIX>/spring-petclinic-tap-demo-source \
  --type web
```
...
```
tanzu apps workload get spring-petclinic-tap-demo
```
